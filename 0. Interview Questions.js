...
// // 1. Is PHP is a loosely type language or strongly typed language ?

// // or 

// // 1. Why PHP is called Loosely Typed Language?

// // Ans : refer https://youtu.be/nB0gTv2P6No video

// // 2. Program to Find Power of any Number in PHP 

// // ANS : refer https://youtu.be/4HSU-1LAE5A


// // 3. PHP Interview Question #2: Difference between Single Quotes and Double Quotes in PHP ? 

// // Ans : refer https://youtu.be/ShRDo9DcvUs

//  // 4. Run PHP Inside HTML | Generating dyanamic HTML content using PHP

// // Ans : refer https://youtu.be/PGPQAr7rZng

// * 5. Interview Question #3: Difference between == vs === in PHP
